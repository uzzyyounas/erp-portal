    ...
    public function run(): void
    {
        ...
        $testimonials = [
            [
                ...
                'client_company' => 'ABC Manufacturing',
                'testimonial' => 'Outstanding work on our facility expansion. The team was professional, efficient, and delivered quality results on time. Highly recommend their structural welding services.',
                'rating' => 5,
                'is_featured' => true,
                'order' => 1,
            ],
            [
                ...
                'client_company' => null,
                'testimonial' => 'The custom railing exceeded our expectations. Beautiful craftsmanship and attention to detail. The installation was quick and clean.',
                'rating' => 5,
                'is_featured' => true,
                'order' => 2,
            ],
            [
                ...
                'client_position' => 'Facilities Director',
                'client_company' => 'XYZ Logistics',
                'testimonial' => 'Reliable and skilled welders. Our gate system has been working flawlessly. Great communication throughout the project.',
                'rating' => 5,
                'is_featured' => true,
                'order' => 3,
            ],
