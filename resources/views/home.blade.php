                ...
                <div class="col-lg-6 hero-content" data-aos="fade-right">
                    ...
                    <div class="mt-4">
                        <a href="{{ route('portfolio.index') }}"
                           class="btn btn-primary-custom me-3 d-none d-md-inline-block">
                            View Portfolio
                        </a>
                            ...
                            <div class="service-card p-4">
                                @if($service->image)
                                    <img src="{{ asset('storage/' . $service->image) }}" alt="{{ $service->title }}"
                                         class="img-fluid service-img-home mb-3 d-block mx-auto">
                                @else
                    ...
                    @foreach($featuredPortfolios as $index => $portfolio)
                        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="{{ $index * 100 }}">
                            <div class="portfolio-item">
                                <img
                                    src="{{ asset('storage/' . $portfolio->thumbnail) ?? 'https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?w=800' }}"
                                    alt="{{ $portfolio->title }}">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8" data-aos="fade-right">
                    ...
                    <p class="lead mb-0">Get a free quote today and let's bring your vision to life with professional
                        welding services.</p>
                </div>
